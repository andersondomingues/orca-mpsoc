...
for { set mem_cnt 1}  {$mem_cnt <= $num_mem} {incr mem_cnt} {
    ...
    # Assuming the starting address of the elf file is 0x40000000 since this is the 
    # default stating address for HFOS.
    # If it is not the case, then this line must match the elf starting address
    puts $fp "ADDRESS_SPACE memory_$mem_cnt COMBINED \[0x40000000:0x40000${top_addr}\]"
...
if {![file exists ./src/orca/0x0.elf]} {
    error "ERROR! Elf-file ./src/orca/0x0.elf is not found."
}
